...
// Genuinely touches every day this week: automatic resolution (1–2), a
// dedicated service provider (3), config-driven selection (4), a proper
// named route (5), and the trace middleware (6) — all in one endpoint.
// ═══════════════════════════════════════════════════════════════════════
