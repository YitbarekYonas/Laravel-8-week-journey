...
// Day 4 — config helper vs typed config object vs the env() anti-pattern.
// Hit this before and after `php artisan config:cache` (see README) to
// observe the difference for real.
Route::get('/config/demo', [ConfigDemoController::class, 'show']);
